...
export default function Writing() {
  ...
  const copyKey = async () => {
    try {
      ...
      toast.success("House key copied. Paste it into Unbound Keyboard on your phone.");
    } catch (e) {
        ...
        <div className="flex items-start gap-3 mb-3">
          ...
          <div>
            ...
            <ol className="text-sm space-y-2 list-decimal pl-5" style={{ color: "var(--text-muted)" }}>
              <li>On a computer with Android Studio, open the <code>android/unbound-keyboard</code> folder and install Unbound Keyboard on the phone.</li>
              <li>Settings → System → Languages &amp; input → On-screen keyboard → Unbound Keyboard. Turn it on, then choose it when you type.</li>
              <li>In Unbound Keyboard settings, paste your house address{house?.house_url ? ` (${house.house_url})` : ""} and tap Copy my house key below.</li>
            </ol>
            <button
              type="button"
