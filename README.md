...
1. Sign in, open **Rooms**.
2. **VR setup coach** (`/rooms/vr`) — pick your headset, follow the illustrated checklist. Downloads are official and free (Meta Horizon Link, SteamVR, ALVR GitHub releases, PICO Connect, PlayStation VR2 App). Virtual Desktop is paid optional — skip it unless you own it.
3. **Headset matrix** (`/rooms/vr/matrix`) or [`docs/vr-compatibility.md`](docs/vr-compatibility.md).
