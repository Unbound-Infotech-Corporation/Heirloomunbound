...
## Unbound Phase 1 — Rooms + assistants
...
- **Assistants** — named specialists under the twin (Settings + Sit/Twin
  picker + `@mention`). PC specialists stay Assist. Heirs never inherit them.
- WinUI Rooms / Assistants documents — **deferred** with Memory Studio.
