    ...
    private static Dictionary<string, HelpTopic> Build()
    {
        ...
        var list = new[]
        {
            ...
            T("setup", "Getting started", "action",
                "One button: Get everything ready. Then clone your voice and take three likeness photos so the Twin can look and sound like you.",
                "No tokens, no model names, no vendor keys on the download path. If voice or photos wait, a reminder sits top-right. Reopen from Help → Remaining setup.",
                "twin", "remaining-setup"),
            T("remaining-setup", "Remaining setup", "action",
                "Dismissible Twin checklist: cloned voice and three likeness photos. Closes without blocking the rest of the studio.",
                "Critical steps are voice and photos. Talking-picture source is tracked. Heirs do not see this panel.",
                "setup", "avatar"),
